...
marcRelatorRoleTerms = ['abr', 'acp', 'act', 'adi', 'adp', 'aft', 'anl', 'anm', 'ann', 'ant', 'ape', 'apl', 'app',
                        ...
                        'cur', 'cwt', 'dbp', 'dfd', 'dfe', 'dft', 'dgg', 'dgs', 'dis', 'dln', 'dnc', 'dnr', 'dpc',
                        'dpt', 'drm', 'drt', 'dsr', 'dst', 'dtc', 'dte', 'dtm', 'dto', 'dub', 'edc', 'edm', 'edt',
                        'egr', 'elg', 'elt', 'eng', 'enj', 'etr', 'evp', 'exp', 'fac', 'fds', 'fld', 'flm', 'fmd',
                        'fmk', 'fmo', 'fmp', 'fnd', 'fpy', 'frg', 'gis', 'grt', 'his', 'hnr', 'hst', 'ill', 'ilu',
                        'ins', 'inv', 'isb', 'itr', 'ive', 'ivr', 'jud', 'jug', 'lbr', 'lbt', 'ldr', 'led', 'lee',
                        'lel', 'len', 'let', 'lgd', 'lie', 'lil', 'lit', 'lsa', 'lse', 'lso', 'ltg', 'lyr', 'mcp',
                        'mdc', 'med', 'mfp', 'mfr', 'mod', 'mon', 'mrb', 'mrk', 'msd', 'mte', 'mtk', 'mus', 'nrt',
                        'opn', 'org', 'orm', 'osp', 'oth', 'own', 'pan', 'pat', 'pbd', 'pbl', 'pdr', 'pfr', 'pht',
                        'plt', 'pma', 'pmn', 'pop', 'ppm', 'ppt', 'pra', 'prc', 'prd', 'pre', 'prf', 'prg', 'prm',
                        'prn', 'pro', 'prp', 'prs', 'prt', 'prv', 'pta', 'pte', 'ptf', 'pth', 'ptt', 'pup', 'rbr',
                        'rcd', 'rce', 'rcp', 'rdd', 'red', 'ren', 'res', 'rev', 'rpc', 'rps', 'rpt', 'rpy', 'rse',
                        'rsg', 'rsp', 'rsr', 'rst', 'rth', 'rtm', 'sad', 'sce', 'scl', 'scr', 'sds', 'sec', 'sgd',
                        'sgn', 'sht', 'sll', 'sng', 'spk', 'spn', 'spy', 'srv', 'std', 'stg', 'stl', 'stm', 'stn',
                        'str', 'tcd', 'tch', 'ths', 'tld', 'tlp', 'trc', 'trl', 'tyd', 'tyg', 'uvp', 'vac', 'vdg',
                        'voc', 'wac', 'wal', 'wam', 'wat', 'wdc', 'wde', 'win', 'wit', 'wpr', 'wst']

## ORDER DOES MATTER!:
pubTypes = ['annotation', 'article', 'bachelorthesis', 'book', 'bookpart', 'bookreview', 'conferencepaper',
            'contributiontoperiodical', 'doctoralthesis', 'researchproposal', 'lecture', 'masterthesis', 'patent',
            'preprint', 'report', 'studentthesis', 'technicaldocumentation', 'workingpaper', 'conferenceobject',
            'other', 'conferenceitem', 'conferenceitemnotinproceedings', 'conferenceposter', 'conferenceproceedings',
            'reportpart', 'review']

# Taken from: http://www.loc.gov/standards/iso639-2/ISO-639-2_utf-8.txt
ISO639 = ["aar", "abk", "ace", "ach", "ada", "ady", "afa", "afh", "afr", "ain", "aka", "akk", "alb", "ale", "alg",
          ...
          "wen", "wln", "wol", "xal", "xho", "yao", "yap", "yid", "yor", "ypk", "zap", "zbl", "zen", "zha", "znd",
          "zul", "zun", "zxx", "zza", "bod", "ces", "cym", "deu", "ell", "eus", "fas", "fra", "hye", "isl", "kat",
          "mkd", "mri", "msa", "mya", "nld", "ron", "slk", "sqi", "zho", "aa", "ab", "ae", "af", "ak", "am", "an", "ar",
          "as", "av", "ay", "az", "ba", "be", "bg", "bh", "bi", "bm", "bn", "bo", "br", "bs", "ca", "ce", "ch", "co",
          "cr", "cs", "cu", "cv", "cy", "da", "de", "dv", "dz", "ee", "el", "en", "eo", "es", "et", "eu", "fa", "ff",
          "fi", "fj", "fo", "fr", "fy", "ga", "gd", "gl", "gn", "gu", "gv", "ha", "he", "hi", "ho", "hr", "ht", "hu",
          "hy", "hz", "ia", "id", "ie", "ig", "ii", "ik", "io", "is", "it", "iu", "ja", "jv", "ka", "kg", "ki", "kj",
          "kk", "kl", "km", "kn", "ko", "kr", "ks", "ku", "kv", "kw", "ky", "la", "lb", "lg", "li", "ln", "lo", "lt",
          "lu", "lv", "mg", "mh", "mi", "mk", "ml", "mn", "mr", "ms", "mt", "my", "na", "nb", "nd", "ne", "ng", "nl",
          "nn", "no", "nr", "nv", "ny", "oc", "oj", "om", "or", "os", "pa", "pi", "pl", "ps", "pt", "qu", "rm", "rn",
          "ro", "ru", "rw", "sa", "sc", "sd", "se", "sg", "si", "sk", "sl", "sm", "sn", "so", "sq", "sr", "ss", "st",
          "su", "sv", "sw", "ta", "te", "tg", "th", "ti", "tk", "tl", "tn", "to", "tr", "ts", "tt", "tw", "ty", "ug",
          "uk", "ur", "uz", "ve", "vi", "vo", "wa", "wo", "xh", "yi", "yo", "za", "zh", "zu"]

BINDING_DELIMITER = '; '

# DATACITE Controlled List Values:
datacite_resourceTypeGeneral = ['Audiovisual', 'Collection', 'Dataset', 'Event', 'Image', 'InteractiveResource',
...
class NormaliseOaiRecord(UiaConverter):
    ...
    def __init__(self, fromKwarg, toKwarg=None, name=None):
        ...
        self._languagePattern = compile(
            '^([A-Za-z]{2,3})(-[a-zA-Z0-9]{1,8})?$')  # Captures first 2 or 3 language chars if nothing else OR followed by '-' and 1 to 8 alfanum chars. See also: ftp://ftp.rfc-editor.org/in-notes/rfc3066.txt

    def _convert(self, lxmlNode):
        self._accesRights = NormaliseOaiRecord.ACCESS_LEVELS[0]  # Reset AccesRights to openAcces

        record_part = lxmlNode.xpath("//document:document/document:part[@name='record']/text()",
        ...
        record_lxml = etree.fromstring(
            record_part[0])  # Geen xml.sax.saxutils.unescape() hier: Dat doet lxml reeds voor ons.
        self._metadataformat = MetadataFormat(record_lxml,
                                              self._uploadid)  # TODO: pass it somehow from DNA, so we need to look this up only once per record.
        converted_record_lxml = self._convertRecordMetadataToLong(
            record_lxml)  # Check en insert normalised mods into record part.
        record_txt = etree.tostring(converted_record_lxml, encoding="UTF-8")  # convert from lxml to text.
        record_txt = record_txt.decode(
            'utf-8')  # Soms worden er chars opgestuurd die geen unicode zijn. Deze converteren we 'brute force'.
    ...
    def _convertRecordMetadataToLong(self, lxmlNode):
        ...
        if self._metadataformat.getFormat() is not None:
            # Create rootelement:
            e_longroot = etree.SubElement(e_norm_root, namespacesmap.curieToTag('long:knaw_long'),
                                          nsmap={None: namespacesmap['long']})
            ...
            if self._metadataformat.isNOD():  # NOD records
                ...
                try:
                    ...
                    if hostCitation:
                        ...
                        etree.SubElement(e_longmetadata,
                                         namespacesmap.curieToTag('long:hostCitation')).text = hostCitation
                except:
    ...
    def _convertNODRecord2long(self, lxmlNode, e_longmetadata):
        ...
        # PROJECT:
            ...
            penvoerder_en = lxmlNode.xpath("//proj:penvoerder/proj:naam[@xml:lang='en']/text()",
                                           namespaces=namespacesmap)
        ...
        if self._metadataformat.isDatacite():
            ...
            if self._metadataformat.isDC():
                ...
                nl = lxmlNode.xpath(root + "mods:titleInfo[@xml:lang='nl']", namespaces=namespacesmap) or \
                     ...
                     lxmlNode.xpath(root + "mods:titleInfo[not(starts-with(@xml:lang, 'en'))]",
                                    namespaces=namespacesmap) or \
                     en
                if len(nl) > 0:
    ...
    def _titleFromTitleInfo(self, titleInfoNode):
        if titleInfoNode is not None:
            title = self._firstElement(
                titleInfoNode.xpath('self::mods:titleInfo/mods:title/text()', namespaces=namespacesmap))
            subtitle = self._firstElement(
                titleInfoNode.xpath('self::mods:titleInfo/mods:subTitle/text()', namespaces=namespacesmap))
    ...
    def _getDataCiteTitleNL(self, titlesNode):
        if titlesNode is not None:
            title = self._firstElement(
                titlesNode.xpath("self::datacite:titles/datacite:title[@xml:lang='nl' and not(@titleType)]/text()",
                                 namespaces=namespacesmap)) or \
                    self._firstElement(titlesNode.xpath(
                        "self::datacite:titles/datacite:title[@xml:lang='nl' and @titleType='TranslatedTitle']/text()",
                        namespaces=namespacesmap)) or \
                    self._firstElement(titlesNode.xpath(
                        "self::datacite:titles/datacite:title[not(@xml:lang) and not(@titleType)]/text()",
                        namespaces=namespacesmap)) or \
                    self._firstElement(titlesNode.xpath(
                        "self::datacite:titles/datacite:title[not(starts-with(@xml:lang, 'en')) and not(@titleType)]/text()",
                        namespaces=namespacesmap))
            alternative_title = self._firstElement(titlesNode.xpath(
                "self::datacite:titles/datacite:title[@xml:lang='nl' and (@titleType='Subtitle' or @titleType='AlternativeTitle')]/text()",
                namespaces=namespacesmap)) or \
                                self._firstElement(titlesNode.xpath(
                                    "self::datacite:titles/datacite:title[not(@xml:lang) and (@titleType='Subtitle' or @titleType='AlternativeTitle')]/text()",
                                    namespaces=namespacesmap)) or \
                                self._firstElement(titlesNode.xpath(
                                    "self::datacite:titles/datacite:title[not(starts-with(@xml:lang, 'en')) and (@titleType='Subtitle' or @titleType='AlternativeTitle')]/text()",
                                    namespaces=namespacesmap))
    ...
    def _getDataCiteTitleEN(self, titlesNode):
        if titlesNode is not None:
            title = self._firstElement(
                titlesNode.xpath("self::datacite:titles/datacite:title[@xml:lang='en' and not(@titleType)]/text()",
                                 namespaces=namespacesmap)) or \
                    self._firstElement(titlesNode.xpath(
                        "self::datacite:titles/datacite:title[@xml:lang='en' and @titleType='TranslatedTitle']/text()",
                        namespaces=namespacesmap)) or \
                    self._firstElement(titlesNode.xpath(
                        "self::datacite:titles/datacite:title[starts-with(@xml:lang, 'en') and not (@titleType)]/text()",
                        namespaces=namespacesmap)) or \
                    self._firstElement(titlesNode.xpath(
                        "self::datacite:titles/datacite:title[starts-with(@xml:lang, 'en') and @titleType='TranslatedTitle']/text()",
                        namespaces=namespacesmap))
            alternative_title = self._firstElement(titlesNode.xpath(
                "self::datacite:titles/datacite:title[starts-with(@xml:lang, 'en') and (@titleType='Subtitle' or @titleType='AlternativeTitle')]/text()",
                namespaces=namespacesmap))
            return [title, alternative_title]
        else:
            return
    ...
    def _getHumanStartPage(self, lxmlNode, e_longRoot):
        ...
        if self._metadataformat.isDatacite():  # Get primary identifier: shoulde be a doi, except for RCE...
            ...
            hsp = self._findFirstXpath(lxmlNode,
                                       '//didl:Item/didl:Item[didl:Descriptor/didl:Statement/rdf:type/@rdf:resource="info:eu-repo/semantics/humanStartPage"]/didl:Component/didl:Resource/@ref',
                                       # DIDL 3.0
                                       '//didl:Item/didl:Item[didl:Descriptor/didl:Statement/dip:ObjectType/text()="info:eu-repo/semantics/humanStartPage"]/didl:Component/didl:Resource/@ref',
                                       # fallback DIDL 2.3.1
                                       "//dc:identifier[contains(.,'://')]/text()",  # fallback DC
                                       "//mods:mods/mods:location/mods:url[contains(.,'://')]/text()",  # fallback MODS
                                       '//didl:Item/didl:Item[didl:Descriptor/didl:Statement/rdf:type/@rdf:resource="info:eu-repo/semantics/objectFile"]/didl:Component/didl:Resource/@ref',
                                       # fallback DIDL 3.0
                                       '//didl:Item/didl:Item[didl:Descriptor/didl:Statement/dip:ObjectType/text()="info:eu-repo/semantics/objectFile"]/didl:Component/didl:Resource/@ref',
                                       # fallback DIDL 2.3.1
    ...
    def _getPersistentIdentifier(self, lxmlNode, e_longRoot):
        if self._metadataformat.isDatacite():
            ...
            pi = lxmlNode.xpath(
                "//datacite:resource/datacite:alternateIdentifiers/datacite:alternateIdentifier[@alternateIdentifierType='URN']/text()",
                namespaces=namespacesmap)
            if len(pi) > 0:  # Found URN, check validity:
                pId = PidFactory.factory('urn', self._firstElement(pi))
                if pId.is_valid():
                    etree.SubElement(e_longRoot, "persistentIdentifier", type="urn",
                                     ref=pId.get_resolver()).text = pId.get_unformatted_id()
                ...
                for pi in pis:
                    ...
                    if len(pid) > 0 and len(pid_type) > 0:  # Found primary identifier and type (probably DOI)
                        primId = PidFactory.factory(pid_type[0], pid[0])
                        if primId.is_valid():
                            etree.SubElement(e_longRoot, "persistentIdentifier", type=primId.get_name(),
                                             ref=primId.get_resolver()).text = primId.get_unformatted_id()
        else:
            pi = lxmlNode.xpath('//didl:DIDL/didl:Item/didl:Descriptor/didl:Statement/dii:Identifier/text()',
                                namespaces=namespacesmap)
            if len(
                    pi) > 0:  # TODO: Hoe weten we welk type identifier hierin gaat? Gaat EduStandaard ALTIJD uit van URN:NBN?
                e_pi = etree.SubElement(e_longRoot, "persistentIdentifier")
                e_pi.text = self._firstElement(pi)
                uri = lxmlNode.xpath('//didl:DIDL/didl:Item/didl:Component/didl:Resource/@ref',
                                     namespaces=namespacesmap)
                if len(uri) > 0:
    ...
    def _getRelatedIdentifiers(self, lxmlNode, e_longmetadata):
        if self._metadataformat.isDatacite():
            identifiers = lxmlNode.xpath("//datacite:resource/datacite:relatedIdentifiers/datacite:relatedIdentifier",
                                         namespaces=namespacesmap)
            for identifier in identifiers:
                attrib_dict = {}
                id_type = identifier.xpath('self::datacite:relatedIdentifier/@relatedIdentifierType',
                                           namespaces=namespacesmap)
                idee = identifier.xpath('self::datacite:relatedIdentifier/text()', namespaces=namespacesmap)
                if len(idee) > 0 and len(
                        id_type) > 0:  # create new element: <related_identifier type="doi" relationType="IsReferencedBy">doi:10.1006/jmbi.1995.0238</related_identifier>
                    relId = PidFactory.factory(id_type[0], idee[0])
                    if relId.is_valid():
                        attrib_dict['type'] = relId.get_name()
                        attrib_dict['idx'] = relId.get_idx_id()
                        id_reltype = identifier.xpath('self::datacite:relatedIdentifier/@relationType',
                                                      namespaces=namespacesmap)
                        id_resourceTypeGeneral = identifier.xpath(
                            'self::datacite:relatedIdentifier/@resourceTypeGeneral', namespaces=namespacesmap)
                        if len(id_reltype) > 0:
                        ...
                        etree.SubElement(e_longmetadata, "related_identifier",
                                         attrib_dict).text = relId.get_unformatted_id()
        elif self._metadataformat.isMods():
            rel_items = lxmlNode.xpath("//mods:mods/mods:relatedItem", namespaces=namespacesmap)
            for item in rel_items:
                attrib_dict = {}
                item_href = item.xpath('self::mods:relatedItem/@xlink:href',
                                       namespaces=namespacesmap)  # Get href from relatedItem
                ...
                attrib_resourceTypeGeneral = item.xpath('self::mods:relatedItem/mods:genre[1]/text()',
                                                        namespaces=namespacesmap)
                if len(attrib_resourceTypeGeneral) > 0: attrib_dict['resourceTypeGeneral'] = attrib_resourceTypeGeneral[
                    0]
                if len(item_href) > 0 and len(
                        item_reltype) > 0:  # Create new element: <related_identifier type="doi" relationType="IsReferencedBy">doi:10.1006/jmbi.1995.0238</related_identifier>
                ...
                for relitem_ID in item.xpath('self::mods:relatedItem/mods:identifier[@type and @type != "local"]',
                                             namespaces=namespacesmap):
    ...
    def _getObjectFiles(self, lxmlNode, e_longRoot):
        ...
        if self._metadataformat.isMods():  # FULLMODS only!
            ...
            if self._metadataformat.isMods3():
                ...
                accesssRights = lxmlNode.xpath(
                    '//didl:DIDL/didl:Item/didl:Item[didl:Descriptor/didl:Statement/rdf:type/@rdf:resource="info:eu-repo/semantics/objectFile"]/didl:Descriptor/didl:Statement/dcterms:accessRights/text()',
                    namespaces=namespacesmap)
            ...
            for objectfile in objectfiles:
                ...
                didl_resources = objectfile.xpath('self::didl:Item/didl:Component/didl:Resource',
                                                  namespaces=namespacesmap)
                ...
                pi = objectfile.xpath('self::didl:Item/didl:Descriptor/didl:Statement/dii:Identifier/text()',
                                      namespaces=namespacesmap)
                if pi:
                ...
                if self._metadataformat.isMods3():
                    # look for embargo:
                    embargo = objectfile.xpath(
                        'self::didl:Item/didl:Descriptor/didl:Statement/dcterms:available/text()',
                        namespaces=namespacesmap)
                    if embargo:
                        e_embargo = etree.SubElement(e_objectFile, "embargo")
                        e_embargo.text = embargo[0].strip()
                        # look for description:
                    descrip = objectfile.xpath('self::didl:Item/didl:Descriptor/didl:Statement/dc:description/text()',
                                               namespaces=namespacesmap)
                    if descrip:
                    ...
                    publicationVersion = objectfile.xpath(
                        'self::didl:Item/didl:Descriptor/didl:Statement/rdf:type/@rdf:resource[contains(.,"published") or contains(.,"author")]',
                        namespaces=namespacesmap)
                    if publicationVersion:  # both (author/publisher) may be available: we'll take the first one...
                        ...
                        e_publicationVersion.text = publicationVersion[0].strip()[
                                                    publicationVersion[0].strip().rfind('/') + 1:]
                    # Look for AccessRights:
                    ar = objectfile.xpath('self::didl:Item/didl:Descriptor/didl:Statement/dcterms:accessRights/text()',
                                          namespaces=namespacesmap)
                    if ar:
    ...
    def _getAccessRights(self, lxmlNode, e_longRoot):
        ...
        if self._metadataformat.isOaiDC():
            ...
            rights = lxmlNode.xpath('//datacite:resource/datacite:rightsList/datacite:rights/text()',
                                    namespaces=namespacesmap)
            if len(rights) > 0:
    ...
    def _getNames(self, lxmlNode, e_longmetadata, root='//mods:mods/'):
        ...
        if self._metadataformat.isMods():
            nameTypes = ['personal', 'corporate', 'conference',
                         'NOTYPE']  # NOTYPE used to catch names without a type attribute! We will tread them as type 'personal'.
            ...
            for nameType in nameTypes:  # alle personal namen, alle corporate namen etc.
                if nameType == nameTypes[3]:  # Change xpath, to get all names without @type
                    ...
                    nameType = nameTypes[
                        0]  # Assign "personal" type to them.... quick & dirty, maar we moeten wat, anders geen datasets van DANS...
                else:
                ...
                for name in names:  # voor iedere personal naam, voor iedere corrporate naam, etc.
                    ...
                    for namepartType in namepartTypes:
                        namePart = name.xpath('self::mods:name/mods:namePart[@type="' + namepartType + '"]/text()',
                                              namespaces=namespacesmap)
                    ...
                    # Get RoleTerm:
                    roleTerm = name.xpath('self::mods:name/mods:role/mods:roleTerm[@authority="marcrelator"]/text()',
                                          namespaces=namespacesmap)
                    ...
                    if extensionid:
                        ...
                        daais = lxmlNode.xpath(
                            root + 'mods:extension/dai:daiList/dai:identifier[@IDref="' + extensionid[
                                0] + '" and @authority]/text()', namespaces=namespacesmap)
                        # Hack, since MODS doc example is in wrong (mods) namespace!
                        if not daais: daais = lxmlNode.xpath(
                            root + 'mods:extension/mods:daiList/mods:identifier[@IDref="' + extensionid[
                                0] + '" and @authority]/text()', namespaces=namespacesmap)
                        for dai in daais:
                    ...
                    for dai in sorted(
                            daiset):  # Add all (sorted, to ease unittesting) unique dai's found from old dailist and nameIdentifiers:
                        e_nid = etree.SubElement(e_name_type, "nameIdentifier")
        ...
        # Get creators and contributors from DC if NO FULLMODS available, or if MMODS did not yield any authors:
            ...
            dc_type_thesis_dissertation = lxmlNode.xpath('//dc:type[contains(.,"issertation") or contains(.,"thesis")]',
                                                         namespaces=namespacesmap)
            dc_type_e = 'ctb'
            ...
            creators = lxmlNode.xpath('//datacite:resource/datacite:creators/datacite:creator',
                                      namespaces=namespacesmap)
            for creator in creators:
                creatorName = creator.xpath('self::datacite:creator/datacite:creatorName/text()',
                                            namespaces=namespacesmap)
                nametype = creator.xpath('self::datacite:creator/datacite:creatorName/@nameType',
                                         namespaces=namespacesmap)
                givenName = creator.xpath('self::datacite:creator/datacite:givenName/text()', namespaces=namespacesmap)
                familyName = creator.xpath('self::datacite:creator/datacite:familyName/text()',
                                           namespaces=namespacesmap)
                nameIdentifier = creator.xpath('self::datacite:creator/datacite:nameIdentifier/text()',
                                               namespaces=namespacesmap)
                nameIdentifierType = creator.xpath(
                    'self::datacite:creator/datacite:nameIdentifier/@nameIdentifierScheme', namespaces=namespacesmap)
                affiliation = creator.xpath('self::datacite:creator/datacite:affiliation/text()',
                                            namespaces=namespacesmap)
                self._nameParts(e_longmetadata, creatorName, givenName, familyName, ['Creator'], nameIdentifier,
                                nameIdentifierType, affiliation, nametype)

            contributors = lxmlNode.xpath('//datacite:resource/datacite:contributors/datacite:contributor',
                                          namespaces=namespacesmap)
            for contributor in contributors:
                creatorName = contributor.xpath('self::datacite:contributor/datacite:contributorName/text()',
                                                namespaces=namespacesmap)
                nametype = creator.xpath('self::datacite:contributor/datacite:contributorName/@nameType',
                                         namespaces=namespacesmap)
                givenName = contributor.xpath('self::datacite:contributor/datacite:givenName/text()',
                                              namespaces=namespacesmap)
                familyName = contributor.xpath('self::datacite:contributor/datacite:familyName/text()',
                                               namespaces=namespacesmap)
                contributorType = contributor.xpath('self::datacite:contributor/@contributorType',
                                                    namespaces=namespacesmap)
                nameIdentifier = contributor.xpath('self::datacite:contributor/datacite:nameIdentifier/text()',
                                                   namespaces=namespacesmap)
                nameIdentifierType = contributor.xpath(
                    'self::datacite:contributor/datacite:nameIdentifier/@nameIdentifierScheme',
                    namespaces=namespacesmap)
                affiliation = contributor.xpath('self::datacite:contributor/datacite:affiliation/text()',
                                                namespaces=namespacesmap)
                self._nameParts(e_longmetadata, creatorName, givenName, familyName, contributorType, nameIdentifier,
                                nameIdentifierType, affiliation, nametype)

    def _nameParts(self, e_longmetadata, name="", givenName="", familyName="", contributorType="", nameIdentifier="",
                   nameIdentifierType="", affiliation="", nametype=None):
        ...
        if len(name) > 0 or len(familyName) > 0 or len(givenName) > 0:
            ...
            if len(nameIdentifier) > 0 and len(nameIdentifierType) > 0 and len(nameIdentifier) == len(
                    nameIdentifierType):  # Transfer all supported identifiers found:
                for idx, nameIdType in enumerate(nameIdentifierType):
                    if nameIdType.lower() in supportedNids or 'dai' in nameIdType.lower():
                        ...
                        if nameId.is_valid():
                            etree.SubElement(e_name_type, "nameIdentifier",
                                             type=nameId.get_name()).text = nameId.get_id()
    ...
    def _getRightsDescription(self, lxmlNode, e_longmetadata):
        if self._metadataformat.isDC():
            ...
            wmp_rights = lxmlNode.xpath('//mods:mods/mods:extension/wmp:rights/dc:description/text()',
                                        namespaces=namespacesmap)
            if len(wmp_rights) > 0:
    ...
    def _getPublisher(self, lxmlNode, e_longmetadata, root='//mods:mods/'):
        if self._metadataformat.isDatacite():
            ...
            publisher = self._findFirstXpath(lxmlNode, root + 'mods:originInfo/mods:publisher[1]/text()',
                                             '//dc:publisher[1]/text()')
        if len(publisher) > 0:
    ...
    def _getPhysicalDescription(self, lxmlNode, e_longmetadata):
        ...
        if self._metadataformat.isMods():
            ...
            if len(modsGenre) > 0 and self._getLabelFromGenreURI(modsGenre[0]) in (
            pubTypes[2], pubTypes[3], pubTypes[8], pubTypes[11], pubTypes[14]):
                m_extend = lxmlNode.xpath('//mods:mods/mods:physicalDescription/mods:extent[1]/text()',
                                          namespaces=namespacesmap)
                if len(m_extend) > 0:
    ...
    def _getSubject(self, lxmlNode, e_longmetadata):
        if self._metadataformat.isDC():
            ...
            en = lxmlNode.xpath("//mods:mods/mods:subject[starts-with(@xml:lang, 'en')]/mods:topic/text()",
                                namespaces=namespacesmap)
            nl = lxmlNode.xpath("//mods:mods/mods:subject[@xml:lang='nl']/mods:topic/text()",
                                namespaces=namespacesmap) or \
                 lxmlNode.xpath("//mods:mods/mods:subject[not(@xml:lang)]/mods:topic/text()",
                                namespaces=namespacesmap) or \
                 lxmlNode.xpath("//mods:mods/mods:subject[not(starts-with(@xml:lang, 'en'))]/mods:topic/text()",
                                namespaces=namespacesmap) or \
                 en
            e_subject = etree.SubElement(e_longmetadata, "subject")
            ...
            en, nl = [], []
            subjects = lxmlNode.xpath("//datacite:resource/datacite:subjects/datacite:subject",
                                      namespaces=namespacesmap)
            for subject in subjects:
                subj_en = subject.xpath("self::datacite:subject[starts-with(@xml:lang, 'en')]",
                                        namespaces=namespacesmap)
                subj_nl = subject.xpath("self::datacite:subject[@xml:lang='nl']", namespaces=namespacesmap) or \
                          ...
                          subject.xpath("self::datacite:subject[not(starts-with(@xml:lang, 'en'))]",
                                        namespaces=namespacesmap)
                if subj_en:
                    en.append(subj_en[0])
                if subj_nl:
    ...
    def _getDataciteTopic(self, e_subject, topics):
        for topic in topics:
            ...
            if (topic.attrib.get('valueURI')):
                if (topic.attrib.get('subjectScheme')) and 'narcis' in topic.attrib.get(
                        'subjectScheme').lower() and topic.attrib.get('valueURI')[
                                                     -5:].isdigit():  # Add @code if NARCIS classification AND valid i.e: should end with at least 5 digits
    ...
    def _getAbstract(self, lxmlNode, e_longmetadata):
        ...
        if self._metadataformat.isDC():
            ...
            descriptions = self._findElementsWithAttributeValue(lxmlNode,
                                                                '//datacite:resource/datacite:descriptions/datacite:description',
                                                                'descriptionType', datacite_descriptionTypes)
    ...
    def _getDescription(self, descriptions, conditions):
        ...
        for condition in conditions:
            for description in descriptions:
                desc = self._findElementsWithAttributeValue(description, 'self::datacite:description', 'xml:lang',
                                                            [condition], text=True)
    ...
    def _findElementsWithAttributeValue(self, node, xpath, attribute_name, conditions, text=False):
        ...
        for condition in conditions:
            items = node.xpath(
                xpath + self._getAttributePredicate(attribute_name, condition) + ("/text()" if text else ""),
                namespaces=namespacesmap)
            if len(items) > 0:
                return items
        return []
    ...
    def _getDates(self, lxmlNode, e_longmetadata, root='//mods:mods/'):
        ...
        if self._metadataformat.isDatacite():
            dateTypes = ['Issued', 'Submitted', 'Accepted', 'Created', 'Updated', 'Available', 'Copyrighted', 'Valid',
                         'Collected']
            for dateType in dateTypes:
                date = lxmlNode.xpath(
                    "//datacite:resource/datacite:dates/datacite:date[@dateType='" + dateType + "']/text()",
                    namespaces=namespacesmap)
                if len(date) > 0:
            ...
            dateIssued = lxmlNode.xpath(
                root + "mods:originInfo/mods:dateIssued[@encoding='w3cdtf' or @encoding='iso8601']/text()",
                namespaces=namespacesmap)
            if len(dateIssued) > 0:
    ...
    def _getAllRecordIdentifiers(self, lxmlNode, e_longmetadata,
                                 root='//mods:mods/'):  # 'similar' record-identifiers AND primary identifier.
        if self._metadataformat.isDatacite():  # Collects all pids: primaryID + alternateIdentifiers
            pids = lxmlNode.xpath(
                "//datacite:resource/datacite:alternateIdentifiers/datacite:alternateIdentifier[@alternateIdentifierType != 'local']",
                namespaces=namespacesmap)
            for identifier in pids:
                ...
                if identifier.text and idType:  # alternateIdentifierType is mandatory by datacite scheme:
                    ...
                    if pId.is_valid():
                        etree.SubElement(e_longmetadata, "publication_identifier", type=pId.get_name(),
                                         idx=pId.get_idx_id()).text = pId.get_unformatted_id()
            ...
            if len(pi) > 0:
                ...
                if len(pid) > 0 and len(pid_type) > 0:  # Found primary identifier and type (probably DOI)
                    primId = PidFactory.factory(pid_type[0], pid[0])
                    if primId.is_valid():
                        etree.SubElement(e_longmetadata, "publication_identifier", type=primId.get_name(),
                                         idx=primId.get_idx_id()).text = primId.get_unformatted_id()
            ...
            if (root == '//mods:mods/'):  # But only if called from toplevel, not if called from RelatedItems...
                pi = lxmlNode.xpath('//didl:DIDL/didl:Item/didl:Descriptor/didl:Statement/dii:Identifier/text()',
                                    namespaces=namespacesmap)  # Primary (persistent) identifier.
                if len(
                        pi) > 0:  # Hoe weten we welk type identifier hierin gaat? EduStandaard gaat uit van URN:NBN, echter worden ook URL's opgestuurd...
                ...
                hsp = self._findFirstXpath(lxmlNode,
                                           ...
                                           '//didl:Item/didl:Item[didl:Descriptor/didl:Statement/dip:ObjectType/text()="info:eu-repo/semantics/humanStartPage"]/didl:Component/didl:Resource/@ref',
                                           # fallback DIDL 2.3.1
                                           "//mods:mods/mods:location/mods:url[contains(.,'://')]/text()"
                                           # fallback MODS
                                           )
                if len(hsp) > 0:
                    hrefId = PidFactory.factory('href', hsp[0])
                    if hrefId.is_valid():  # Type 'href/url' gevonden...
                        etree.SubElement(e_longmetadata, "publication_identifier", type=hrefId.get_name(),
                                         idx=hrefId.get_idx_id()).text = hrefId.get_unformatted_id()
    ...
    def _getLanguage(self, lxmlNode, e_longmetadata):
        if self._metadataformat.isDatacite():
            ...
            rfc3066_language = self._findFirstXpath(lxmlNode,
                                                    "//mods:mods/mods:language/mods:languageTerm[@type='code' and @authority='rfc3066']/text()",
                                                    "//dc:language[1]/text()")  # Greedy fallback DC. If all else fails...
    ...
    def _getLocationUrl(self, lxmlNode, e_longmetadata):
        ...
        if self._metadataformat.isMods():
            locations = lxmlNode.xpath("//mods:mods/mods:location/mods:url[contains(.,'://')]/text()",
                                       namespaces=namespacesmap)
    ...
    def _getRelatedItems(self, lxmlNode, e_longmetadata):
        ...
        if self._metadataformat.isMods():
            ...
            for relateditemtype in relateditemtypes:
                relatedItems = lxmlNode.xpath('//mods:mods/mods:relatedItem[@type="' + relateditemtype + '"]',
                                              namespaces=namespacesmap)
                for relatedItem in relatedItems:  # voor iedere relatedItem per host, series, etc.
                    ...
                    methodNames = [self._getTitleInfo, self._getAllRecordIdentifiers, self._getNames, self._getDates,
                                   self._getPlaceterm, self._getPublisher, self._getGenre]
    ...
    def _getPlaceterm(self, lxmlNode, e_longmetadata, root='//mods:mods/'):
        ...
        if self._metadataformat.isMods():
            placeterms = lxmlNode.xpath(root + "mods:originInfo/mods:place/mods:placeTerm[@type='text']/text()",
                                        namespaces=namespacesmap)
            if len(placeterms) > 0:
    ...
    def _getFormat(self, lxmlNode, e_longmetadata):
        formats = []
        if self._metadataformat.isDatacite():
            formats = lxmlNode.xpath("//datacite:resource/datacite:formats/datacite:format/text()",
                                     namespaces=namespacesmap)
        elif self._metadataformat.isDC():
    ...
    def _getTypeOfResource(self, lxmlNode, e_longmetadata):
        ...
        if self._metadataformat.isDatacite():
            typeOfResources = lxmlNode.xpath("//datacite:resource/datacite:resourceType/text()",
                                             namespaces=namespacesmap)
            generealTypeOfResources = lxmlNode.xpath("//datacite:resource/datacite:resourceType/@resourceTypeGeneral",
                                                     namespaces=namespacesmap)
            if len(typeOfResources) > 0:
                e_tor = etree.SubElement(e_longmetadata, "typeOfResource")
                e_tor.text = generealTypeOfResources[0] + '/' + typeOfResources[0] if generealTypeOfResources and \
                                                                                      generealTypeOfResources[0] <> \
                                                                                      typeOfResources[0] else \
                typeOfResources[0]
                if len(generealTypeOfResources) > 0 and generealTypeOfResources[0].lower() in [dctype.lower() for dctype
                                                                                               in
            ...
            if len(typeOfResources) > 0 and typeOfResources[0].lower().strip() in [dctype.lower() for dctype in
                                                                                   datacite_resourceTypeGeneral]:
                etree.SubElement(e_longmetadata, "typeOfResource",
                                 generaltype=typeOfResources[0].lower().strip()).text = typeOfResources[
                    0].lower().strip()
    ...
    def _getFunding(self, lxmlNode, e_longmetadata):
        ...
        if self._metadataformat.isDatacite():
            funders = lxmlNode.xpath("//datacite:resource/datacite:fundingReferences/datacite:fundingReference",
                                     namespaces=namespacesmap)
            if len(funders) > 0:
                ...
                for ga in funders:
                    ...
                    title = ga.xpath('self::datacite:fundingReference/datacite:awardTitle/text()',
                                     namespaces=namespacesmap)
                    if len(title) > 0: etree.SubElement(e_ga, "title").text = title[0]

                    fname = ga.xpath('self::datacite:fundingReference/datacite:funderName/text()',
                                     namespaces=namespacesmap)
                    if len(fname) > 0: etree.SubElement(e_ga, "funder").text = fname[0]

                    anumber = ga.xpath('self::datacite:fundingReference/datacite:awardNumber/text()',
                                       namespaces=namespacesmap)
                    if len(anumber) > 0: etree.SubElement(e_ga, "description").text = anumber[0]
                    auri = ga.xpath('self::datacite:fundingReference/datacite:awardNumber/@awardURI',
                                    namespaces=namespacesmap)
                    if len(auri) > 0: etree.SubElement(e_ga, "code").text = auri[0]

                    fidtxt = ga.xpath('self::datacite:fundingReference/datacite:funderIdentifier/text()',
                                      namespaces=namespacesmap)
                    if len(fidtxt) > 0:
                        fidtype = ga.xpath(
                            'self::datacite:fundingReference/datacite:funderIdentifier/@funderIdentifierType',
                            namespaces=namespacesmap)
                        if len(fidtype) > 0:
                            funderId = NameIdentifierFactory.factory(fidtype[0], fidtxt[0])
                            if funderId.is_valid():
                                etree.SubElement(e_ga, "funderIdentifier",
                                                 type=funderId.get_name()).text = funderId.get_id()
                        else:
            ...
            gas = lxmlNode.xpath("//mods:mods/mods:extension/gal:grantAgreementList/gal:grantAgreement[@code]",
                                 namespaces=namespacesmap)
            ...
            for ga in gas:
                ...
                if GaFunderId:
                    ...
                    funder = lxmlNode.xpath(
                        '//mods:mods/mods:name[@ID="' + GaFunderId[0] + '"]/mods:displayForm/text()',
                        namespaces=namespacesmap)
                    if not funder:
                        funder = lxmlNode.xpath(
                            '//mods:mods/mods:name[@ID="' + GaFunderId[0] + '"]/mods:namePart/text()',
                            namespaces=namespacesmap)
                    if funder:
    ...
    def _getGeoLocations(self, lxmlNode, e_longmetadata):
        if self._metadataformat.isDatacite():
            geoLocations = lxmlNode.xpath("//datacite:resource/datacite:geoLocations/datacite:geoLocation",
                                          namespaces=namespacesmap)
            if len(geoLocations) > 0:
                ...
                for geoLocation in geoLocations:
                    ...
                    geoLocationPlaces = geoLocation.xpath('self::datacite:geoLocation/datacite:geoLocationPlace/text()',
                                                          namespaces=namespacesmap)
                    for geoLocationPlace in geoLocationPlaces:
                        etree.SubElement(e_geoLocation, "geoLocationPlace").text = geoLocationPlace
                    geoLocationPoints = geoLocation.xpath('self::datacite:geoLocation/datacite:geoLocationPoint',
                                                          namespaces=namespacesmap)
                    for geoLocationPoint in geoLocationPoints:
                        pointLongitude = geoLocationPoint.xpath(
                            'self::datacite:geoLocationPoint/datacite:pointLongitude/text()', namespaces=namespacesmap)
                        pointLatitude = geoLocationPoint.xpath(
                            'self::datacite:geoLocationPoint/datacite:pointLatitude/text()', namespaces=namespacesmap)
                    ...
                    geoLocationBoxes = geoLocation.xpath('self::datacite:geoLocation/datacite:geoLocationBox',
                                                         namespaces=namespacesmap)
                    for geoLocationBox in geoLocationBoxes:
                        northBoundLatitude = geoLocationBox.xpath(
                            'self::datacite:geoLocationBox/datacite:northBoundLatitude/text()',
                            namespaces=namespacesmap)
                        eastBoundLongitude = geoLocationBox.xpath(
                            'self::datacite:geoLocationBox/datacite:eastBoundLongitude/text()',
                            namespaces=namespacesmap)
                        southBoundLatitude = geoLocationBox.xpath(
                            'self::datacite:geoLocationBox/datacite:southBoundLatitude/text()',
                            namespaces=namespacesmap)
                        westBoundLongitude = geoLocationBox.xpath(
                            'self::datacite:geoLocationBox/datacite:westBoundLongitude/text()',
                            namespaces=namespacesmap)
                        if len(northBoundLatitude) > 0 and len(eastBoundLongitude) > 0 and len(
                                southBoundLatitude) > 0 and len(westBoundLongitude) > 0:
    ...
    def _getPublicationYear(self, lxmlNode, e_longmetadata):
        if self._metadataformat.isDatacite():
            ...
            if len(pubyear) > 0: etree.SubElement(e_longmetadata, "publicationYear").text = self._normaliseDate(
                pubyear[0])

    ################### Helper methods #########################

    def _getHostCitation(self, lxmlNode):
        relatedItems = lxmlNode.xpath("//long:knaw_long/long:metadata/long:relatedItem[@type='host']",
                                      namespaces=namespacesmap)
        if len(relatedItems) > 0:
            title, page, volume, published, issn = '', '', '', '', ''
            relatedItem = relatedItems[0]
            titles = relatedItem.xpath('self::long:relatedItem/long:titleInfo/long:title/text()',
                                       namespaces=namespacesmap)
            ...
            if volumes and volumes[0] != 'None':
                ...
                issue = relatedItem.xpath('self::long:relatedItem/long:part/long:issue/text()',
                                          namespaces=namespacesmap)
                if issue:
                    volume = '%s(%s)' % (volume, issue[0])
            start_page = relatedItem.xpath('self::long:relatedItem/long:part/long:start_page/text()',
                                           namespaces=namespacesmap)
            end_page = relatedItem.xpath('self::long:relatedItem/long:part/long:end_page/text()',
                                         namespaces=namespacesmap)
    ...
    def _addRelatedItemPart(self, lxmlNode, relatedItemType, relatedItemElement):
        ...
        if self._metadataformat.isMods():
            ...
            for detail_type in detail_types:  # Haal alle numbers op: (Er kan er maar 1 per type zijn)
                numbers = lxmlNode.xpath(
                    'self::mods:relatedItem/mods:part/mods:detail[@type="' + detail_type + '"]/mods:number[1]/text()',
                    namespaces=namespacesmap)
                if numbers:
            ...
            for extent_element in extent_elements:  # Haal alle extend sub-elementen op en pak de eerste start, end etc. die we tegenkomen.
                pages = lxmlNode.xpath(
                    'self::mods:relatedItem/mods:part/mods:extent[@unit="page"]/mods:' + extent_element + '[1]/text()',
                    namespaces=namespacesmap)
                if pages:
    ...
    def _DCType2PublicationType(self, dctype):
        ...
        if dctype in pubTypes:
            return dctype  # 1:1 occurences
        elif (dctype.find('newspaper') >= 0):
            return pubTypes[7]
        elif (dctype.find('conferencereport') >= 0):
            return pubTypes[18]
        elif (dctype.find('conference') >= 0 or dctype.find('inmonograph') >= 0 or dctype.find('inproceedings') >= 0):
            return pubTypes[6]
        elif (dctype.find('dissertation') >= 0):
            return pubTypes[8]
        elif (dctype.find('lecture') >= 0):
            return pubTypes[10]
        elif (dctype.find('article') >= 0 or dctype.find('bookreview') >= 0):
            return pubTypes[1]
        elif (dctype.find('report') >= 0):
            return pubTypes[14]
        elif (dctype.find('paper') >= 0):
            return pubTypes[17]
        elif (dctype.find('partofbook') >= 0 or dctype.find('chapterofbook') >= 0):
            return pubTypes[4]
        elif (dctype.find('book') >= 0):
            return pubTypes[3]
        return ''
    ...
    def _isISO8601(self, datestring):
        ...
        try:
            parseDate(datestring, ignoretz=True,
                      fuzzy=False)  # Fuzzy True will pass any date found in any srting i.e: "opgraafdatum 3000 jaar voor christus" will pass. (yielding '3000')
        except ValueError:
            return False
        return True
    ...
    def _normaliseDate(self, str_date):
        ...
        di_1 = parseDate(str_date, ignoretz=True, fuzzy=True, default=datetime(1900, 12, 28, 0,
                                                                               0))  # 1900-12-28 default year, month and day. (day 28 exists for every month:-)
        di_2 = parseDate(str_date, ignoretz=True, fuzzy=True,
                         default=datetime(2000, 01, 01, 0, 0))  # 2000-01-01 default year, month and day.
        ...
        if di_1.date().day != di_2.date().day and di_1.date().month == di_2.date().month:
            return ('%s-%s') % (
            di_1.date().year, di_1.date().month)  # Only year and month have been parsed succesfully.
